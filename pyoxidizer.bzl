...
def make_exe():
    ...
    python_config.run_module = "dvcli"
    ...
    # From https://pyoxidizer.readthedocs.io/en/latest/pyoxidizer_packaging_python_files.html#packaging-an-application-from-a-local-python-package
    # we learn that we can simply use the local python setup and add it via pip...
